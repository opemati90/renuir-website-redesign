    ...
    <motion.section className="app-container mt-28" id="features">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-16">
        {features.map((feature, index) => (
          ...
          >
            <div className="flex items-center justify-center h-12 w-12 rounded-lg bg-primary-50 hover:bg-primary-700 transition-all duration-100 ">
              <feature.icon className="h-8 w-8 text-primary-600 hover:text-primary-50" />
            </div>

            <Typography variant="h5" className="font-bold mt-2 mb-2">
              {feature.title}
            </Typography>
