...
export default function TermsPage() {
  return (
    <>
      ...
      <p>
        Welcome to Renuir. These Terms and Conditions ("Terms") govern your use
        of our website and services (collectively, the "Service"). By accessing
      ...
      <p>
        ...
        item descriptions and images). By submitting content, you grant Renuir a
      ...
      <p>
        ...
        and will remain the exclusive property of Renuir UG (haftungsbeschränkt)
        and its licensors. Our trademarks, logos, and service marks may not be
      ...
      <p>
        ...
        Renuir does not control and is not responsible for the content, privacy
        policies, or practices of third-party sites. Your use of third-party
      ...
      <p>
        ...
        GUARANTEE THE SUCCESSFUL RETURN OF ANY LOST ITEM.
      </p>
      ...
      <p>
        ...
        of law provisions. Any legal action or proceeding arising under these
        Terms shall be brought exclusively in the courts located in Berlin,
        Germany.
      </p>
      ...
      <p>
        ...
        claim, you agree to contact us at legal@renuir.com to attempt to resolve
        any dispute informally. We will try to resolve the dispute within 30
        days.
      </p>
      <p>
      ...
      <p>
        ...
        will notify you of any material changes by posting the new Terms on this
