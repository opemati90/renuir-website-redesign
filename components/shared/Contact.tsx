...
import { Mail, MessageCircle, HelpCircle, Clock, Twitter, Linkedin, Instagram } from "lucide-react";

export default function ContactPage() {
  return (
    <div className="max-w-4xl space-y-8">
      <div>
        <Typography variant="h2" className="mb-2 text-gray-900 font-bold text-3xl md:text-4xl lg:text-5xl">
          Contact Support
        </Typography>
      ...
      <div className="prose prose-gray max-w-none space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-xl bg-gray-50 border border-gray-100 hover:shadow-md transition-shadow">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h4 className="text-lg font-bold text-gray-900">General Inquiries</h4>
            ...
            <div className="p-6 rounded-xl bg-gray-50 border border-gray-100 hover:shadow-md transition-shadow">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h4 className="text-lg font-bold text-gray-900">Partnerships</h4>
            ...
            <div className="p-6 rounded-xl bg-gray-50 border border-gray-100 hover:shadow-md transition-shadow">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h4 className="text-lg font-bold text-gray-900">Privacy & Legal</h4>
          ...
          <div className="flex items-start gap-4 p-6 rounded-xl bg-primary-50 border border-primary-100">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed text-base md:text-lg">
                ...
                For urgent matters, please mark your email as urgent and we'll prioritize your request.
              </p>
            </div>
          </div>
        </section>
        ...
        {/* Quick Links */}
        <section className="space-y-4 border-t border-gray-100 pt-8">
          <h3 className="text-xl md:text-2xl font-semibold text-gray-900">Quick Links</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Guidelines for safe item returns</p>
              </div>
            </Link>
          </div>
        </section>
        ...
        {/* Social Media */}
        <section className="space-y-4 border-t border-gray-100 pt-8">
          <h3 className="text-xl md:text-2xl font-semibold text-gray-900">Follow Us</h3>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
        ...
        {/* Company Info */}
        <section className="space-y-4 border-t border-gray-100 pt-8">
          <h3 className="text-xl md:text-2xl font-semibold text-gray-900">Company Information</h3>
